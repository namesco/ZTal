...
class Ztal_Controller_Action_Helper_View extends Zend_Controller_Action_Helper_Abstract
{
	...
	public function preDispatch()
	{
		...
		$phptal->setTemplateRepository(SITE_ROOT_PATH . DIRECTORY_SEPARATOR . 'application' . DIRECTORY_SEPARATOR
			. ($module != '' ? 'modules' . DIRECTORY_SEPARATOR . $module : '') . DIRECTORY_SEPARATOR . 'views'
