<?php
/**
 * Table paginator unit tests with page numbers starting at one.
 *
 * @category  Namesco
 * @package   UnitTesting
...
class PaginatorFirstPageOneTests extends \PHPUnit\Framework\TestCase
{
	...
	public function testPagesOne()
	{
		...
		$expected = array(
			array('index' => 1, 'label' => 1, 'currentPage' => true),
		);
	...
	public function testPagesMany()
	{
		...
		$expected = array(
			array('index' => 1, 'label' => 1, 'currentPage' => false),
			array('index' => 2, 'label' => 2, 'currentPage' => true),
			array('index' => 3, 'label' => 3, 'currentPage' => false),
		);
